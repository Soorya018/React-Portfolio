...
const about = {
  ...
  imageSize: 375,
  message:
    "My name is Arun Soorya. I’m a graduate in Computer Engineering currently working as Technical Engineer - Support at Squadcast. I'm most passionate about giving back to the community, and my goal is to pursue this passion within the field of analytics.",
  resume: "https://drive.google.com/file/d/1vTkJPtBO8nGyy5Nd6IgPI4HOZXK9nL-7/view?usp=sharing",
};
...
const skills = {
  ...
  hardSkills: [
    ...
    { name: "Data Analytics & Visualization", value: 80 },
...
const experiences = {
  ...
  data: [
    {
      role: 'Technical Engineer - Support, Zoho Corporation',// Here Add Company Name
      companylogo: require('../assets/img/zoho-logo.png'),
      imgSize: 170,
      date: 'January 2021 – September 2022',
    },
    {
      role: 'Customer Success Engineer, Squadcast Labs',
